        ...
        {messages.map((message, index) => {
          ...
          if (message.type === 'local/system') {
            return (
              <div
                key={index}
                className="messages__item messages__item--system">
                <div className="messages__item__metadata">
                  <div className="messages__item__metadata__name">
                    System<span>{moment(message.time).format('h:mm A')}</span>
                  </div>
            ...
            return (
              <div key={index} className="messages__item">
                <div className="messages__item__avatar">
                  {repeatedAuthor ? null : (
                    <Avatar name={message.author || 'conspirator'} />
                  )}
                </div>
                <div className="messages__item__metadata">
                  {repeatedAuthor ? null : (
                    <div className="messages__item__metadata__name">
                      {message.author || 'conspirator'}
            ...
            return (
              <div key={index} className="messages__item messages__item--emote">
                ...
                <div className="messages__item__metadata">
                  ...
                  <div className={repeatedAuthor ? 'text indent' : 'text'}>
                    {enrichText(`${message.author} ${message.content}`)}
                  </div>
                </div>
              </div>
            );
